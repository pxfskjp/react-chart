...
import { Pie, Bar, HorizontalBar, Line } from "react-chartjs-2";
...
function App() {
  const series = new TimeSeries({
    name: "USD_vs_EURO",
    columns: ["time", "value"],
    points: timeData.widget[0].data.reverse()
  });
  ...
  return (
    <div className="App p-3">
      ...
      <div className="row mt-5">
        <div className="col">
          <h2>Line</h2>
          <Line data={lineData} legend={legend} options={lineOptions} />
        </div>
        <div className="col">
          <h2>Timeseries</h2>
          <Resizable>
